...
-- Popups
L_POPUP_INSTALLUI = "Es la primera vez que usas TKUI con este personaje. Usted debe volver a cargar la interfaz de usuario para configurarlo."
L_POPUP_RESETUI = "¿Estás seguro de que desea restablecer TKUI?"
...
L_POPUP_DISABLEUI = "TKUI no funciona con esta resolución, ¿Quieres desactivar TKUI? (Pulsa cancelar si quieres probar otra resolución)"
...
-- Welcome message
L_WELCOME_LINE_1 = "Bienvenido a TKUI "
L_WELCOME_LINE_2_1 = "Escribe /cfg para configurar la interfaz, o visita https://github.com/Wetxius/TKUI_Help/wiki/English"
...
L_SLASHCMD_HELP = {
	...
	"/resetconfig - Reinicia la configuración de TKUI_Config.",
