...
-- Popups
L_POPUP_INSTALLUI = "该角色首次使用TKUI，你必须重新加载UI来配置。"
L_POPUP_RESETUI = "你确定要重新加载TKUI?"
L_POPUP_RESETSTATS = "你确定要重置所有角色游戏时间和金币的统计数据?"
L_POPUP_DISBAND_RAID = "你确定要解散团队?"
L_POPUP_DISABLEUI = "TKUI不支持此分辨率，是否停用TKUI? (若要尝试其他分辨率请按取消)"
...
-- Welcome message
L_WELCOME_LINE_1 = "欢迎使用TKUI "
L_WELCOME_LINE_2_1 = "键入 /cfg 进行插件设置, 或者访问https://github.com/Wetxius/TKUI_Help/wiki/English"
