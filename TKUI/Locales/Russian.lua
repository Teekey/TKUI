...
-- Popups
L_POPUP_INSTALLUI = "Это первый запуск TKUI для этого персонажа. Необходимо перезагрузить интерфейс для его настройки."
L_POPUP_RESETUI = "Вы уверены, что хотите сбросить настройки TKUI?"
...
L_POPUP_DISABLEUI = "TKUI не работает на этом разрешении, хотите отключить TKUI? (Отмена, если хотите попробовать другое разрешение)"
...
-- Welcome message
L_WELCOME_LINE_1 = "Добро пожаловать в TKUI "
L_WELCOME_LINE_2_1 = "Введите /cfg для входа в настройки интерфейса, или посетите страницу https://github.com/Wetxius/TKUI_Help/wiki/Русский"
...
L_SLASHCMD_HELP = {
	...
	"/resetconfig - Сброс настроек TKUI_Config.",
