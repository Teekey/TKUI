...
-- Popups
L_POPUP_INSTALLUI = "該角色首次使用TKUI，你必須重新加載UI來配置。"
L_POPUP_RESETUI = "你確定要重新加載TKUI?"
L_POPUP_RESETSTATS = "你確定要重置所有角色遊戲時間和金幣的統計數據?"
L_POPUP_DISBAND_RAID = "你確定要解散團隊?"
L_POPUP_DISABLEUI = "TKUI不支援此解析度，是否停用TKUI? (若要嘗試其他解析度請按取消)"
...
-- Welcome message
L_WELCOME_LINE_1 = "歡迎使用TKUI "
L_WELCOME_LINE_2_1 = "鍵入 /cfg 進行UI設置, 或者訪問 https://github.com/Wetxius/TKUI_Help/wiki/English"
