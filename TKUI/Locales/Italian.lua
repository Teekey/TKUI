...
-- Popups
L_POPUP_INSTALLUI = "È la prima volta che utilizzi la TKUI con questo personaggio. Devi riavviare l'interfaccia utente per configurarla."
L_POPUP_RESETUI = "Vuoi davvero ripristinare tutte le impostazioni iniziali della TKUI?"
...
L_POPUP_DISABLEUI = "A questa risoluzione la TKUI non funziona correttamente, vuoi disabilitare l'AddOn (clicca 'Cancella' se vuoi provare con un'altra risoluzione)?"
...
-- Welcome message
L_WELCOME_LINE_1 = "Benvenuto/a in TKUI "
L_WELCOME_LINE_2_1 = "Digita /cfg per configurare l'interfaccia oppure visita https://github.com/Wetxius/TKUI_Help/wiki/English"
...
L_SLASHCMD_HELP = {
	...
	"/resetconfig - Riporta le impostazioni della TKUI_Config a quelle iniziali.",
