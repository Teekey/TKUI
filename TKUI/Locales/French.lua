...
-- Popups
L_POPUP_INSTALLUI = "Première utilisation de TKUI avec ce personnage. Vous devez recharger l'interface utilisateur pour le configurer."
L_POPUP_RESETUI = "Etes-vous sûr de vouloir réinitialiser TKUI ?"
...
L_POPUP_DISABLEUI = "TKUI ne fonctionne pas avec cette résolution, voulez-vous désactiver TKUI ? (Annuler si vous souhaitez essayer une autre résolution)"
...
-- Welcome message
L_WELCOME_LINE_1 = "Bienvenue sur TKUI "
L_WELCOME_LINE_2_1 = "Tapez /cfg pour configurer l'interface, ou visitez https://github.com/Wetxius/TKUI_Help/wiki/English"
...
L_SLASHCMD_HELP = {
	...
	"/resetconfig - Remet les paramètres TKUI_Config à leurs valeurs par défaut.",
