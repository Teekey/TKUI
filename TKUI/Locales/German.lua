...
-- Popups
L_POPUP_INSTALLUI = "Dies ist Ihre erste Benutzung von TKUI mit diesem Charakter. Um das Interface zu konfigurieren, wird das UI nun neugeladen."
L_POPUP_RESETUI = "Sind Sie sich sicher, dass Sie die Einstellungen von TKUI zurückgesetzen wollen?"
...
L_POPUP_DISABLEUI = "TKUI funktioniert nicht mit deiner Auflösung, möchtest du TKUI ausschalten? (Drücke Abbrechen, falls du eine andere Auflösung testen willst)"
...
-- Welcome message
L_WELCOME_LINE_1 = "Willkommen bei TKUI "
L_WELCOME_LINE_2_1 = "Gebe /cfg ein um das Interface zu konfigurieren, oder besuche https://github.com/Wetxius/TKUI_Help/wiki/English"
...
L_SLASHCMD_HELP = {
	...
	"/resetconfig - Zurücksetzen der TKUI_Config Einstellungen.",
