...
-- Popups
L_POPUP_INSTALLUI = "First time on TKUI with this Character. You must reload UI to configure it."
L_POPUP_RESETUI = "Are you sure you want to reset all settings for TKUI?"
...
L_POPUP_DISABLEUI = "TKUI doesn't work for this resolution, do you want to disable TKUI? (Cancel if you want to try another resolution)"
...
-- Welcome message
L_WELCOME_LINE_1 = "Welcome to TKUI "
L_WELCOME_LINE_2_1 = "Type /cfg to config interface, or visit https://github.com/Wetxius/TKUI_Help/wiki/English"
...
L_SLASHCMD_HELP = {
	...
	"/resetconfig - Resets TKUI_Config settings.",
