...
coords:SetScript("OnEvent", function(self, event)
	...
	if TKUISettingsPerChar and TKUISettingsPerChar.Coords ~= true then
		coords:SetAlpha(0)
	end
end)
...
-- return TKUISettingsPerChar.Coords == true
-- end

-- info.func = function()
-- if TKUISettingsPerChar.Coords == true then
-- TKUISettingsPerChar.Coords = false
-- coords:SetAlpha(0)
-- else
...
-- info.text = L_MAP_FOG
-- info.checked = function()
-- return TKUISettingsPerChar.FogOfWar == true
-- end

-- info.func = function()
-- if TKUISettingsPerChar.FogOfWar == true then
-- TKUISettingsPerChar.FogOfWar = false
