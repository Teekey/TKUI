...
--	Constants
----------------------------------------------------------------------------------------
local BUTTON_SIZE = C.actionbar.button_size
local BUTTON_SPACING = C.actionbar.button_space
...
local function createConsumableButton(itemID, index)
    ...
    button.t:SetTexture(GetItemIcon(itemID))
...
local function sortConsumables(a, b)
    local _, _, _, _, _, typeA, subtypeA = GetItemInfo(a)
    local _, _, _, _, _, typeB, subtypeB = GetItemInfo(b)
