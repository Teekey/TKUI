...
-- 	local bg = bar:Get("bigwigs:tkui:bg")
-- 	if bg then
-- 		bg:ClearAllPoints()
...
-- 	local ibg = bar:Get("bigwigs:tkui:ibg")
-- 	if ibg then
-- 		ibg:ClearAllPoints()
...
-- 	BigWigsAPI:RegisterBarStyle("tkui", {
-- 		apiVersion = 1,
-- 		version = 1,
-- 		GetSpacing = function() return T.Scale(13) end,
-- 		ApplyStyle = applystyle,
-- 		BarStopped = freestyle,
-- 		GetStyleName = function() return "tkui" end,
-- 	})

-- 	if BigWigsLoader and myProfile and myProfile.barStyle == "tkui" then
