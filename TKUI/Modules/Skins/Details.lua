...
hooksecurefunc(_detalhes, "SetFontOutline", function(_, fontString)
	...
	if fonte == "Interface\\AddOns\\TKUI\\Media\\Fonts\\Pixel.ttf" then
...
local skinTable = {
	file = [[Interface\AddOns\TKUI\Media\Textures\TKUITexture.tga]],
	author = "Teekey",
	version = "1.0",
	site = "unknown",
	desc = "TKUI style skin.",
	...
	instance_cprops = {
		...
		["row_info"] = {
			...
			["font_face_file"] = "Interface\\AddOns\\TKUI\\Media\\Fonts\\Pixel.ttf",
			["backdrop"] = {
				["enabled"] = false,
				["size"] = 12,
				["color"] = {
			...
			["font_size"] = 14,
			["height"] = 18,
			["texture_file"] = "AddOns\\TKUI\\Media\\Textures\\TKUITexture.tga",
			...
			["texture_custom"] = "AddOns\\TKUI\\Media\\Textures\\TKUITexture.tga",
			["texture"] = "Smooth!",
			["textL_class_colors"] = false,
			["alpha"] = 1,
			["no_icon"] = false,
			["texture_background"] = "Smooth!",
			["texture_background_file"] = "AddOns\\TKUI\\Media\\Textures\\TKUITexture.tga",
...
_detalhes.skins["TKUI"] = skinTable
