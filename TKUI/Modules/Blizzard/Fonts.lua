...
frame:SetScript("OnEvent", function(_, _, addon)
	if addon ~= "TKUI" or addon == "tekticles" then return end
	...
	SetFont(ChatBubbleFont, NORMAL, C.font.bubble_font_size, "OUTLINE")
	...
	SetFont(ObjectiveTrackerHeaderFont, NORMAL, 16 * C.font.quest_tracker_font_mult, "OUTLINE") -- Quest title and objectives
	SetFont(ObjectiveTrackerLineFont, NORMAL, 14 * C.font.quest_tracker_font_mult, "OUTLINE") -- Quest tracker
end)
