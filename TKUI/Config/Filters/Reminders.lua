...
local function SpellName(id)
	...
	if name then
		...
		print("|cffff0000TKUI: Reminders spell ID [" .. tostring(id) .. "] no longer exists!|r")
		return { "Empty", "" }
	end
end
...
if C.reminder.solo_buffs_enable == true then
	T.ReminderSelfBuffs = {
		...
		PALADIN = {
			...
			[2] = {    -- Tank Consecration Buff
				["spells"] = {
					SpellName(188370), -- Consecration Aura
				},
				["combat"] = true,
				["instance"] = true,
				["spec"] = 2,
